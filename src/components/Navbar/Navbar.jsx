        ...
        <>
            <nav>
                <Popup
                    ...
                    hideOnScroll
                    trigger={
                        <div style={{ width: '100%', backgroundColor: 'red', borderRadius: '0 0 1em 1em', fontWeight: '300', paddingBottom: '', cursor: 'pointer', fontFamily: "Inter, Avenir, Helvetica, Arial, sans-serif" }}><b><p>
